...
Equipment is a thing. It is undescribed. It is in the Lab Room. The description of the equipment is "Volumetric Flasks, beakers, work gloves, and goggles make up the equipment."

The Volumetric Flasks are things. It is undescribed. It is in the Lab Room. The description of the volumetric flasks are "Used to mix different chemicals in, and create experiments."

The beakers are things. It is undescribed. It is in the Lab Room. The description of the beakers are "A lipped cylindrical glass container used by chemists."

The Work gloves are things. It is undescribed. It is in the Lab Room. The description of the work gloves are "White elastic gloves that stretch onto your hand. Just in case you get the chemicals on your hand."
...
The shiny object is a thing. It is undescribed. It is in the Lab Room. "This seems to be a piece of Rubidium, I wonder what it's doing here…. It's very dangerous."
...
The Silver Crystals are things. It is undescribed. It is in the Pristine Library. The description of the silver crystals is "Shiny and smooth crystals that gives the library an amazing glow."

The Historical Books are things. It is undescribed. It is in the Pristine Library. The description of the historical books is "Some of these books are brand new in your day and age. I guess they're historical treasures to the future now."

The Black Book is a thing. It is undescribed. It is in the Pristine Library. The description of the black book is "A book with no words on its spine. Looks more like a plastic prop than an actual book. Wonder why it's here."
[make the book unlock a secret passage way by pushing the book inwards]

The painting is scenery. It is undescribed. It is in the Pristine Library. The description of the painting is "The old man in the painting looks formally dressed in a black suit and red tie. Is he supposed to be important or something?" 

The glass door is an open door. It is undescribed. It is south of the Pristine Library and north of Facial Salon. The glass door is not openable. The description of the glass door is "An extremely clear door that automatically opens diagonally when it senses your movement."


[The Garage]

The tools are things. It is undescribed. It is in the Garage. The description of the tools is "All of the tools are glowing different colors in this small garage. The only refined tool that you can make out seems to be a glowing red machete and some shears. The rest of the tools are just wands with a button on them. That seems interesting… "

The Red Machete is a thing. It is undescribed. It is in the garage. The description of the red machete is "A broad, large knife with a dark red glow on the ends of it."

The Shears are things. It is undescribed. It is in the Garage. The description of the Shears is "An unusally pair of shears. They are surprisingly very thick and long; could possibly be mistaken for two spears tied together."

The wands are things. It is undescribed. It is in the Garage. The description of the wands is "Each of these wand-looking sticks, have a different glowing color from one another. The button can be promising…"
...
The Garage is a room. It is west of the lab room. "This must be someone's garage. Definately not yours, that's for sure. Many intricate tools and devices hang from the walls and racks. A marvelous car is parked in the middle of it!"
...
The Jump is a room. It is west of the DNA Beach. "A long and twelve foot wall that juts out of the land connected to the beach."
